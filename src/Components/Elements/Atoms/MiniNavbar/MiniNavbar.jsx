...
//     },
//     { name: "Headlines", path: "/News/headlines", titleContent: "Headlines Page" },
//   ];
...
//       titleContent: "Categories Page",
//     },
//     { name: "Headlines", path: "/news/headlines", titleContent: "Headlines" }, // Update this path
//   ];
...
const MiniNavbar = () => {
  ...
  const navItems = [
    ...
    { name: "Headlines", path: "/news/headlines", titleContent: "Headlines" }, // Update this path to "/news/headlines"
  ];
  ...
  // Apply hover class for active links
  const isActive = (item) => {
